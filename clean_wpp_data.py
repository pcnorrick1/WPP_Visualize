...
wpp_estimates_2024 = pd.read_csv('WPP_2024_Estimates_raw.csv',encoding='latin-1',low_memory=False)
wpp_median_2024 = pd.read_csv('WPP_2024_Median_raw.csv',encoding='latin-1',low_memory=False)
wpp_low_2024 = pd.read_csv('WPP_2024_Low_raw.csv',encoding='latin-1',low_memory=False)
...
wpp_median_2024.rename(columns={'Region, subregion, country or area *':'Country'}, inplace=True)
wpp_low_2024.rename(columns={'Region, subregion, country or area *':'Country'}, inplace=True)
...
wpp_median_2024.to_csv('WPP_2024_Median_clean.csv',index=False)
wpp_low_2024.to_csv('WPP_2024_Low_clean.csv',index=False)